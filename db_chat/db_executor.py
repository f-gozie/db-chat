...
class PostgreSQLExecutor:
    ...
    def __init__(self, connection_string=None):
        ...
        self.connection_string = connection_string or "postgresql://debug:debug@postgres:5432/eyemark_backend"
        self.conn = None
        ...
        try:
            ...
            for table in tables:
                ...
                for constraint in check_constraints:
                    ...
                    match = re.search(r'\(\("?([a-zA-Z0-9_]+)"?\)::text = ANY \(ARRAY\[(.*?)\]\)\)', constraint_def)
                    if match:
